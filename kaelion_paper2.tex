...
where $m_\lambda$ is the mass of the $\lambda$ field:
\begin{equation}
m_\lambda^2 = \frac{1}{2}V''(0) = \frac{1}{2} \cdot 2V_0 = V_0 = \sqrt{3}
\end{equation}

Therefore:
\begin{equation}
m_\lambda = 3^{1/4} = \sqrt[4]{3}
\end{equation}

and:
\begin{equation}
\boxed{w = \frac{1}{\sqrt[4]{3}} = \frac{1}{\sqrt{2\sqrt{3}}} \approx 0.54\,\ell_P}
\label{eq:width}
\end{equation}
...
$m_\lambda$ & $\sqrt[4]{12}$ & 1.8612 & $m^2 = V''(0)/2$ \\
$c$ & $2\pi$ & 6.2832 & SYK scrambling \\
$w$ & $1/\sqrt{2\sqrt{3}}$ & $0.54\,\ell_P$ & Kink width \\
\bottomrule
\end{tabular}
...
\begin{enumerate}
    ...
    \item \textbf{Zero free parameters:} All constants ($\phi_0 = 1/\sqrt{3}$, $V_0 = \sqrt{3}$, $c = 2\pi$, $w = 0.54\,\ell_P$) are derived
